...
REGIONS = [
    ("Kenya", "KE", "Africa"), ("Uganda", "UG", "Africa"), ("Tanzania", "TZ", "Africa"),
    ("Rwanda", "RW", "Africa"), ("Burundi", "BI", "Africa"), ("Ethiopia", "ET", "Africa"),
    ("Somalia", "SO", "Africa"), ("South Sudan", "SS", "Africa"), ("Sudan", "SD", "Africa"),
    ("Djibouti", "DJ", "Africa"), ("Eritrea", "ER", "Africa"), ("Nigeria", "NG", "Africa"),
    ("Ghana", "GH", "Africa"), ("South Africa", "ZA", "Africa"), ("Zimbabwe", "ZW", "Africa"),
    ("Zambia", "ZM", "Africa"), ("Malawi", "MW", "Africa"), ("Mozambique", "MZ", "Africa"),
    ("Angola", "AO", "Africa"), ("Namibia", "NA", "Africa"), ("Botswana", "BW", "Africa"),
    ("Cameroon", "CM", "Africa"), ("Congo", "CD", "Africa"), ("Madagascar", "MG", "Africa"),
    ("Mauritius", "MU", "Africa"), ("Egypt", "EG", "Africa"), ("Libya", "LY", "Africa"),
    ("Israel", "IL", "Asia"), ("Iran", "IR", "Asia"), ("Iraq", "IQ", "Asia"),
    ("Turkey", "TR", "Asia"), ("India", "IN", "Asia"), ("Pakistan", "PK", "Asia"),
    ("Bangladesh", "BD", "Asia"), ("Nepal", "NP", "Asia"), ("Sri Lanka", "LK", "Asia"),
    ("China", "CN", "Asia"), ("Japan", "JP", "Asia"), ("Korea", "KR", "Asia"),
    ("Taiwan", "TW", "Asia"), ("Thailand", "TH", "Asia"), ("Vietnam", "VN", "Asia"),
    ("Myanmar", "MM", "Asia"), ("Indonesia", "ID", "Asia"), ("Philippines", "PH", "Asia"),
    ("United Kingdom", "GB", "Europe"), ("Ireland", "IE", "Europe"), ("France", "FR", "Europe"),
    ("Germany", "DE", "Europe"), ("Italy", "IT", "Europe"), ("Spain", "ES", "Europe"),
    ("Portugal", "PT", "Europe"), ("Netherlands", "NL", "Europe"), ("Belgium", "BE", "Europe"),
    ("Switzerland", "CH", "Europe"), ("Austria", "AT", "Europe"), ("Sweden", "SE", "Europe"),
    ("Norway", "NO", "Europe"), ("Denmark", "DK", "Europe"), ("Finland", "FI", "Europe"),
    ("Poland", "PL", "Europe"), ("Greece", "GR", "Europe"), ("Russia", "RU", "Europe"),
    ("Ukraine", "UA", "Europe"),
    ("United States", "US", "Americas"), ("Canada", "CA", "Americas"),
    ("Mexico", "MX", "Americas"), ("Brazil", "BR", "Americas"), ("Argentina", "AR", "Americas"),
    ("Chile", "CL", "Americas"), ("Peru", "PE", "Americas"), ("Colombia", "CO", "Americas"),
    ("Ecuador", "EC", "Americas"), ("Haiti", "HT", "Americas"), ("Jamaica", "JM", "Americas"),
    ("Caribbean", "", "Americas"),
    ("Australia", "AU", "Oceania"), ("New Zealand", "NZ", "Oceania"),
    ("Papua New Guinea", "PG", "Oceania"), ("Fiji", "FJ", "Oceania"), ("Samoa", "WS", "Oceania"),
]
